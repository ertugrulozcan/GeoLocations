...
namespace GeoLocations.MMDB.Exceptions
{
	...
	public sealed class InvalidDatabaseException : Exception
	{
		...
		/// <paramref name="innerException" /> parameter is not a null reference, the current exception is raised in a catch block that handles the inner exception.</param>
